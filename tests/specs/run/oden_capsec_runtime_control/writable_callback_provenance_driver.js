...
const child = new Deno.Command(Deno.execPath(), {
  args: [
    ...
    new URL("writable_callback_provenance_child.js", here).pathname,
    String(port),
  ],
  env: {
    ...Deno.env.toObject(),
    ODEN_CAPSEC_POLICY: new URL(
      "capsec_writable_callbacks.json",
      here,
    ).pathname,
    ODEN_WRITABLE_CALLBACK_SENTINEL: "root-visible",
  },
  stdout: "piped",
  stderr: "piped",
}).spawn();
...
if (output === null) {
  ...
  throw new Error(
    `Writable callback provenance fixture child hung\n${
